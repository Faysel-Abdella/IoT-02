...
const PdfGenerator = ({ toggleState }) => {
  ...
  useEffect(() => {
    const data =
      typeof window !== "undefined" && localStorage.getItem("pdfData");
        ...
        <View style={styles.pageContainer}>
          <View style={styles.section}>
            ...
            <Text style={styles.text}>
              {parsedData?.manufacturedIn} {parsedData?.modelNumber}
            </Text>
            {
              <Text style={styles.text}>
                Firmware version:
                ...
                - updated on:{" "}
                {parsedData?.updatedOn ? parsedData?.updatedOn : ""}
              </Text>
            }
            {
              <Text style={styles.text}>
                The device was manufactured in:{" "}
                <Text>
            ...
            <View style={styles.secruityListItemContainer}>
              <View style={styles.securityItems}>
                <View style={styles.nameContainer}>
                  <Text style={styles.securityListHeading}>
                    Security Updates
                  </Text>
                </View>
              ...
              <View style={styles.accessControlsItems}>
                ...
                <View style={styles.valueContainer}>
                  <Text style={styles.text}>
                    {parsedData?.accessControls?.isPasswordChecked
                      ? "Password"
                      : ""}
                    {parsedData?.accessControls?.isFactoryDefaultChecked
                      ? " - Factory Default"
                      : ""}
                    {parsedData?.accessControls?.isUserGeneratedChecked
                      ? " - User Generated"
                      : ""}
                    {parsedData?.accessControls?.isUserChangeableChecked
                      ? " - User Changeable"
                      : ""}
                  </Text>
                  <Text style={styles.text}>
                    {parsedData?.accessControls?.biometricState
                      ? "Biometric"
                      : ""}
                  </Text>
                  <Text style={styles.text}>
                    {parsedData?.accessControls?.multiFactorState
                      ? "Multi-factor Authentication"
                      : ""}
                  </Text>
                  <Text style={styles.text}>
                    {parsedData?.accessControls?.noControlState
                      ? "No Control Over access"
                      : ""}
                  </Text>
                  <Text style={styles.text}>
                    {parsedData?.accessControls?.multipleUserState
                      ? "Multiple User"
                      : ""}
                    {parsedData?.accessControls?.requiredUserAccounts
                      ? " - Required User Accounts"
                      : ""}
                    {parsedData?.accessControls?.noUserAccountState
                      ? " - No User Account"
                      : ""}
                  </Text>
                </View>
          ...
          <View style={styles.securitySection}>
            ...
            <View style={styles.secruityListItemContainer}>
                ...
                <View style={styles._table}>
                    ...
                    <View style={styles.tableCol}>
                      <View style={styles.iconContainer}>
                        <Image
                          ...
                          style={[
                            styles.icon,
                            parsedData?.sensorDataCollection === "Visual"
                    ...
                    <View style={styles.tableCol}>
                      <View style={styles.iconContainer}>
                        <Image
                          ...
                          style={[
                            styles.icon,
                            parsedData?.sensorDataCollection === "Audio"
                              ? styles.selectedImage
                              : styles.unselectedImage,
                          ]}
                        />
                    ...
                    <View style={styles.tableCol}>
                      <View style={styles.iconContainer}>
                        <Image
                          ...
                          style={[
                            styles.icon,
                            parsedData?.sensorDataCollection === "Physiological"
                              ? styles.selectedImage
                              : styles.unselectedImage,
                          ]}
                        />
                    ...
                    <View style={styles.tableCol}>
                      <View style={styles.iconContainer}>
                        <Image
                          ...
                          style={[
                            styles.icon,
                            parsedData?.sensorDataCollection === "Location"
                              ? styles.selectedImage
                              : styles.unselectedImage,
                          ]}
                        />
                  ...
                  <View style={styles.tableRow}>
                    ...
                    <View style={styles.tableCol}>
                      <View style={styles.tableInnerContainer}>
                        <Text style={styles._text}>
                          {parsedData?.sensorDataCollection === "Visual" &&
                          parsedData?.sensorType?.length > 0
                    ...
                    <View style={styles.tableCol}>
                      <View style={styles.tableInnerContainer}>
                        <Text style={styles._text}>
                          {parsedData?.sensorDataCollection ===
                            "Physiological" &&
                          parsedData?.sensorType?.length > 0
                            ? parsedData?.sensorType
                            : ""}
                  ...
                  <View style={styles.tableRow}>
                    ...
                    <View style={styles.tableCol}>
                      <View style={styles.tableInnerContainer}>
                        <Text style={styles._text}>
                          {parsedData?.sensorDataCollection ===
                            "Physiological" && parsedData?.purpose?.length > 0
                            ? parsedData?.purpose
                            : ""}{" "}
                        </Text>
                      </View>
              ...
              {parsedData?.cloudData?.additionalInfo1 && (
                <View
                  style={[
                    styles.secruityListItemContainer,
                    { padding: 2, width: "100%" },
                  ]}
                >
                  <View
          ...
          <View style={styles.securitySection}>
            ...
            <View style={styles.secruityListItemContainer}>
              ...
              >
                ...
                <View style={styles.valueContainer}>
                  <Text style={styles.accessText}>Not Disclosed</Text>
                </View>
              </View>
            </View>
          </View>
