        ...
        <div className="form-container">
          ...
          <div className="field-wrapper">
            <div className="form-group sensor-wrapper">
              <label htmlFor="dataStoredInCloud">
          ...
          <div className="field-wrapper">
            <div className="form-group sensor-wrapper">
              <label htmlFor="cloudDataRetentionTime">
              ...
              <select
                ...
                className="width-339"
              >
                <option value="Less than five minutes">
          ...
          <div className="field-wrapper">
            <div className="form-group sensor-wrapper">
              ...
              >
                ...
                <option value="Government and legal authorities">
          ...
          <div className="field-wrapper">
            <div className="form-group sensor-wrapper">
              <label htmlFor="dataSharingFrequency">
              ...
              <select
                ...
                className="width-339"
              >
                <option value="When an event happens">
                  When an event happens
                </option>
                <option value="When third parties request it">
                  When third parties request it
                </option>
                <option value="When user requests it">
                  When user requests it
                </option>
                <option value="Periodic">Periodic</option>
                <option value="Continuous">Continuous</option>
                <option value="When required by law">
