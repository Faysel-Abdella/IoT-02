  ...
  if (currentItem === "Controller" || currentItem === "Dataprocessor") {
    content = (
      <>
        ...
        <p>
          Collect only the data necessary for your goals to keep it relevant and
          limited.
        </p>
        <a href="https://gdpr-info.eu/art-5-gdpr/" onClick={onLearnMoreClick}>
          Learn more
        </a>
      </>
    );
    ...
    content = (
      <>
        ...
        <a href="https://gdpr-info.eu/art-13-gdpr/" onClick={onLearnMoreClick}>
          Learn more
        </a>
      </>
    );
